		...
		struct us_unusual_dev *unusual_dev)
{
	...
	/* Store the entries */
	/* Here subclass and protocol settings are taking from unusual_dev */
	...
	pr_info("unusual_dev->useProtocol: %d\n", unusual_dev->useProtocol);
	pr_info("unusual_dev->useTransport: %d\n", unusual_dev->useTransport);

	pr_info("USB_SC_DEVICE: %d\tUSB_PR_DEVICE:%d\n", USB_SC_DEVICE, USB_PR_DEVICE);
	pr_info("us->subclass: %d\tus->protocol: %d\n", us->subclass, us->protocol);
...
//	}
	...
	pr_info("USB_PR_BULK: %d\n", USB_PR_BULK);
	pr_info("USB_SC_SCSI: %d\n", USB_SC_SCSI);
...
static int __init usb_storage_init(void)
{
	...
	pr_info("Registering the USB mass storage driver...\n");
...
{
	pr_info("De-registering the USB driver...\n");
